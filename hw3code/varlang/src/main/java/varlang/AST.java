...
public interface AST {
	...
	public static class UniqueExp extends Exp {
		List<String> _names;
		List<Exp> _value_exps;
		Exp _body;

		public UniqueExp(List<String> names, List<Exp> value_exps, Exp body) {
			_names = names;
			_value_exps = value_exps;
			_body = body;
		}
	...
	public static class LeteExp extends Exp {
		...
		public LeteExp(List<String> names, List<Exp> value_exps, Exp body, Exp enc) {
			_enc = enc;
			_names = names;
			_value_exps = value_exps;
			_body = body;
		...
		public Exp enc(){return _enc;}
	}

	public static class DecExp extends VarExp {
		NumExp _decoder;
		public DecExp( NumExp decoder, String s ) {
			super( s );
			_decoder = decoder;
		}
		public NumExp decoder() {
			return _decoder;
		}
		public Object accept( Visitor visitor, Env env ) {
			return visitor.visit( this, env );
	...
	public interface Visitor <T> {
		...
		public T visit(AST.UniqueExp e, Env env);
