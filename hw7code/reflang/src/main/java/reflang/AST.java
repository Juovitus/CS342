...
public interface AST {
	...
	public static class RefHashtagExp extends Exp{
		private Exp hashExpr;
		public RefHashtagExp(Exp hashExpr){ this.hashExpr = hashExpr;}
		public Exp getHashExpr(){ return hashExpr;}
		public Object accept(Visitor visitor, Env env) {return visitor.visit(this, env);}
		public Exp RefHashtagExp(){return hashExpr;}
	}
	...
	public interface Visitor <T> {
		...
		public T visit(AST.RefHashtagExp e, Env env);
	}
}
